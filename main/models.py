...
class UserInformation(models.Model):
    ...
    device_mac_address = models.CharField(max_length=20, unique=True, verbose_name="Địa chỉ MAC của thiết bị")
    bw_upload = models.IntegerField(default=10000, verbose_name="Băng thông upload (Kbps)")
    bw_download = models.IntegerField(default=10000, verbose_name="Băng thông download (Kbps)")
    ...
    device_type = models.ForeignKey("DeviceType", on_delete=models.CASCADE, verbose_name="Loại thiết bị")

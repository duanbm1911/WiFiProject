 ...
 *   https://datatables.net/download/#bs/dt-1.10.24/af-2.3.6
 *
 * Included libraries:
...
(function(k) {
    ...
    u.ext = L = {
        buttons: {},
        classes: {},
        builder: "bs/dt-1.10.24/af-2.3.6",
        errMode: "alert",
        feature: [],
        search: [],
...
*/
(function(b) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs", "datatables.net-autofill"], function(a) { return b(a, window, document) }) : "object" === typeof exports ? module.exports = function(a, c) {
        a || (a = window);
